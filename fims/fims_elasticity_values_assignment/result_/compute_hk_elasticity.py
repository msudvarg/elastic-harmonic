...
hk_duration = ['500', '1000', '1500', '2000', '2500', '3000', '3500', '4000', '4500', '5000']
n_fixed_array_cpp = []

for i in range(len(hk_duration)):
    n_Dp_fixed_cpp_path = 'n_Dp_fixed_hk_' + hk_duration[i] + '.txt'
...
plt.plot(hk_duration, mean_cos_similarities, marker='o', linestyle='-', color='b')
